                        ...
                        >
                          ...
                          >
                            <Text
                              ...
                              sx={{ fontWeight: "700", fontSize: "1.5rem" }}
                            >
                              {dayjs(novinka.datum, "D-M-YYYY").format("D") !== "Invalid Date" && dayjs(novinka.datum, "D-M-YYYY").format("D")}
                            </Text>
                            <div style={{ display: "flex" }}>
                              <Text
                                size="xl"
                                sx={{ fontWeight: "400", fontSize: "1rem" }}
                              >
                                {dayjs(novinka.datum, "D-M-YYYY").format("M") !== "Invalid Date" && dayjs(novinka.datum).format("M")}
                              </Text>
                              <Text
                                size="xl"
                                sx={{ fontWeight: "400", fontSize: "1rem" }}
                              >
                                {dayjs(novinka.datum, "D-M-YYYY").format("YYYY") !== "Invalid Date" && dayjs(novinka.datum).format("YYYY")}
                              </Text>
                            </div>
                          </div>
                          <Text
